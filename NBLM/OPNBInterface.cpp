...
void OPNBInterface::setSSGNote(uint8_t channel, audioDef::Note note, uint8_t octave)
{
    ...
    _opnb.setRegister(chip::OPNB::REG_SSG_FINE_TUNE+channel, ssgPitch & 0x0F, chip::OPNB::Register::A);
    _opnb.setRegister(chip::OPNB::REG_SSG_COARSE_TUNE+channel, ssgPitch >> 8, chip::OPNB::Register::A);
}
